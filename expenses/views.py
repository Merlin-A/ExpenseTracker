...
def expense_edit(request, id):
    # to get the user details and get that speicific detail sheet
...
def expense_category_summary(request):
    ...
    # set so all the categories even teh duplicate ones are listed
...
def export_csv(request):
    ...
    response['Content-Disposition'] = 'attachment; filename = ' + str(request.user) + '\'s ' + 'Expenses - ' + \
...
#     response['Content-Disposition'] = 'inline; attachment; filename = ' + str(request.user) + '\'s ' + 'Expenses - ' +\
...
# total = Expense.objects.filter(amount='amount')
